 ...
 */
public class ShortGoalLostOutcomeAspect
    ...
    public ShortGoalLostOutcomeAspect(Collection<PlayerBid> bids, SystemNotificationService systemNotificationService) {
