package com.clemble.casino.server.game.rule.time.action;
...
public class TimeRuleScheduleTest {
    ...
    // Assert.assertEquals(1, ruleScheduler.poll().getSessionKey());
    // }
    //
    // @Test
    ...
    // Assert.assertEquals(2, ruleScheduler.poll().getSessionKey());
    // }
