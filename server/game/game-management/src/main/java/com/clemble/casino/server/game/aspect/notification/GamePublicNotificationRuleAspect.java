...
public class GamePublicNotificationRuleAspect extends GameAspect<GameManagementEvent> {

    final private Logger LOG = LoggerFactory.getLogger(GamePublicNotificationRuleAspect.class);

    final private String tableChannel;
    final private Collection<String> participants;
    final private ServerNotificationService notificationService;

    public GamePublicNotificationRuleAspect(String sessionKey, Collection<String> participants, ServerNotificationService notificationService) {
