 ...
 */
public class MatchWonBySpentRuleAspect extends BasicGameAspect<GameEndedEvent<?>> {

    final private Currency currency;
    final private ServerPaymentTransactionService transactionService;

    public MatchWonBySpentRuleAspect(Currency currency, ServerPaymentTransactionService transactionService) {
