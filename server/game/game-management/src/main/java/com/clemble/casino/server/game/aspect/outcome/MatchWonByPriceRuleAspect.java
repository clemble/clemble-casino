 ...
 */
public class MatchWonByPriceRuleAspect extends BasicGameAspect<GameEndedEvent<?>>{
    
    final private Logger LOG = LoggerFactory.getLogger(MatchWonByPriceRuleAspect.class);

    final private Money price;
    final private ServerPaymentTransactionService transactionService;

    public MatchWonByPriceRuleAspect(Money price, ServerPaymentTransactionService transactionService) {
