...
public class InstantGameConstructionTest {
    ...
    public void testInstantConstruction() {
        ...
        GameConstruction constructionA = constructionService.construct(new AutomaticGameRequest(specification));
        // Step 3. Generating player B
        String B = RandomStringUtils.random(10);
        GameConstruction constructionB = constructionService.construct(new AutomaticGameRequest(specification));
