 ...
 * */
@TypeDefs(value = {
        @TypeDef(name = "game_request", typeClass = com.clemble.casino.game.construct.GameRequestHibernate.class, defaultForType = com.clemble.casino.game.construct.GameRequest.class),
