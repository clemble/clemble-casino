...
public class PropertiesSpringConfiguration implements SpringConfiguration {
    ...
    @Configuration
    @PropertySource(name = "clembleConfig", value = "classpath:config/default.properties")
    @Profile(value = { DEFAULT, INTEGRATION_TEST, INTEGRATION_DEFAULT })
    public static class Default {
    }

    @Configuration
    @PropertySource(name = "clembleConfig", value = "classpath:config/test.properties")
    @Profile(value = {TEST})
    ...
    @PropertySource(name = "clembleConfig", value = "classpath:config/cloud.properties")
