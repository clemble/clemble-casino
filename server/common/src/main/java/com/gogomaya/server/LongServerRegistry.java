...
public class LongServerRegistry implements Serializable {
    ...
    public LongServerRegistry() {
    }

    @JsonCreator
    public LongServerRegistry(@JsonProperty("range") Collection<Entry<String, String>> ranges) {
        if (ranges == null)
            return;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LongServerRegistry other = (LongServerRegistry) obj;
