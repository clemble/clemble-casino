...
public class PlayerConnectionDiscoveryBonusService implements BonusService<SystemPlayerConnectionDiscoveredEvent>{

    final private static PaymentBonusSource BONUS_SOURCE = PaymentBonusSource.discovery;
    ...
    public PlayerConnectionDiscoveryBonusService(
    ...
    public void onEvent(SystemPlayerConnectionDiscoveredEvent event) {
        ...
        PaymentBonusMarker bonusMarker = new PaymentBonusMarker(bonusKey, event.getDiscovered());
