...
public class SocialConnectionDataAdapter {
    ...
    public Long register(SocialConnectionData socialConnectionData) {
        ...
        if (existingUsers.size() == 1) {
            ...
            if (connection.test()) {
                ...
                playerId = existingUsers.iterator().next();
                ConnectionRepository connectionRepository = usersConnectionRepository.createConnectionRepository(playerId);
            ...
            playerId = usersConnectionRepository.findUserIdsWithConnection(connection).iterator().next();
        } else {
    ...
    public SocialConnectionData add(long playerId, SocialConnectionData socialConnectionData) {
        ...
        if (existingUsers.size() == 1) {
            ...
            if (!existingUser.equals(String.valueOf(playerId))) {
        ...
        usersConnectionRepository.createConnectionRepository(String.valueOf(playerId)).addConnection(connection);
