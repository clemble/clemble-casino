...
@EnableJpaRepositories(basePackages = "com.gogomaya.server.game", entityManagerFactoryRef="gameEntityManagerFactory")
...
public class GameJPASpringConfiguration {
    ...
    @Inject
    public JpaDialect gameJpaDialect() {
    ...
    public PlatformTransactionManager annotationDrivenTransactionManager() {
        ...
        transactionManager.setJpaDialect(gameJpaDialect());
