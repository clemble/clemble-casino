...
public class IntegrationPlayerProfileService implements PlayerProfileService {
    ...
    final private String playerRegistry;
    final private RestTemplate restTemplate;

    public IntegrationPlayerProfileService(String player, RestTemplate restTemplate) {
    ...
    public PlayerProfile getPlayerProfile(String player) {
        ...
        return restTemplate.exchange(toProfileUrl(PROFILE_PLAYER), HttpMethod.GET, null, PlayerProfile.class, player).getBody();
    }
    ...
    public PlayerProfile updatePlayerProfile(String player, PlayerProfile newProfile) {
        ...
        return restTemplate.exchange(toProfileUrl(PROFILE_PLAYER), HttpMethod.PUT, requestEntity, PlayerProfile.class, player).getBody();
    }
