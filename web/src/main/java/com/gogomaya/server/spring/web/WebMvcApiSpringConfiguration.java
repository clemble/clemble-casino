...
@Configuration
public class WebMvcApiSpringConfiguration implements SpringConfiguration {

    /**
     * {@link org.springframework.data.rest.repository.RepositoryExporter} implementation for exporting JPA repositories.
     */
    @Autowired(required = false)
    public JpaRepositoryExporter customJpaRepositoryExporter;
     ...
     */
    @Autowired(required = false)
    public RepositoryRestConfiguration repositoryRestConfig = RepositoryRestConfiguration.DEFAULT;
