...
@Configuration
@Import({ PropertiesSpringConfiguration.class, CommonSpringConfiguration.Cloud.class, RabbitSpringConfiguration.class, JPASpringConfiguration.class, RedisSpringConfiguration.class })
