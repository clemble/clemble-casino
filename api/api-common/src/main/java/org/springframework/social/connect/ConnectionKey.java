...
/**
 * The unique business key for a {@link Connection} instance. A composite key that consists of the providerId (e.g. "facebook") plus providerUserId (e.g.
 * "125660"). Provides the basis for connection equals() and hashCode().
 * 
 * @author Keith Donald
 */
...
public final class ConnectionKey implements Serializable {
    ...
    /**
     * The id of the external provider user representing the remote end of the connection. May be null if this information is not exposed by the provider. This
     * value should never change. Must be present to support sign-in by the provider user. Must be present to establish multiple connections with the provider.
     */
