...
public class RSAKeySecret implements SignatureSecret {
    ...
    /**
     * Create an RSA public key secret with the given private and public key value. The value of the private key is assumed to be the PKCS#8-encoded bytes of
     * the private key. The value of the public key is assumed to be the X509-encoded bytes of the public key.
     * 
     * @param privateKey
    ...
    /**
     * Create an RSA public key secret with the given private and public key. The values are assumed to be the Base64-encoded values of the bytes of the keys,
     * X509-encoded for the public key and PKCS#8-encoded for the private key.
     * 
     * @param privateKey
     *            The value of the private key.
     * @param publicKey
    ...
    /**
     * Create an RSA public key secret with the given public key value. The value is assumed to be the X509-encoded bytes of the public key. The private key
     * will be null.
     * 
     * @param publicKey
     *            The value of the public key.
    ...
    /**
     * Create an RSA public key secret with the given public key value. The value is assumed to be the Base64-encoded value of the X509-encoded bytes of the
     * public key. The private key will be null.
     * 
     * @param publicKey
     *            The value of the public key.
     */
     ...
     * 
     * @param publicKey
     *            The X509-encoded public key bytes.
     ...
     * 
     * @param privateKey
     *            The PKCS#8-encoded private key bytes.
