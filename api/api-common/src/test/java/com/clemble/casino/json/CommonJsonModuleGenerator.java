...
@Ignore
public class CommonJsonModuleGenerator {

    final private static String MODULE = "Common";

    @Test
    public void findCandidates() {
        Collection<Class<?>> candidates = AnnotationReflectionUtils.findCandidates("com.clemble.casino", JsonTypeName.class);
        ...
        for (Class<?> candidate : candidates) {
            ...
            System.out.println("        module.registerSubtypes(new NamedType(" + candidateClass + ", " + candidateClass
