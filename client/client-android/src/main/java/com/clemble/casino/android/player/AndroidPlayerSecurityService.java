...
import com.clemble.casino.client.player.PlayerSecurityClientOperations;

public class AndroidPlayerSecurityService implements PlayerSecurityClientOperations<HttpEntity<?>> {
