...
public class SocialConnectionDataAdapter {
    ...
    public String adapt(SocialConnectionData socialConnectionData) {
        // Step 1. Sanity check
        ...
        Set<String> existingUsers = connectionRepository.findUserIdsConnectedTo(socialConnectionData.getProviderId(), ImmutableSet.<String>of(socialConnectionData.getProviderUserId()));
